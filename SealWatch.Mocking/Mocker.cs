...
public static class Mocker
{
    ...
    private static string[] _soilTypes = new string[] { "Harter Boden", "Normaler Boden", "Weicher Boden" };
    ...
    private static Faker<Cutter> _fakeCutters = new Faker<Cutter>()
        ...
        .RuleFor(x => x.MillingStart, date => date.Date.Between(DateTime.Now.AddDays(-100), DateTime.Now.AddDays(30)))
        .RuleFor(x => x.MillingStop, stopDate => stopDate.Date.Between(DateTime.Now.AddDays(31), DateTime.Now.AddDays(200)))
        ...
        .RuleFor(x => x.SoilType, type => _soilTypes[_random.Next(0, 2)]);
