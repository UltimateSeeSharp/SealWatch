...
/// <summary>
/// For loading properties asynchronously
/// </summary>
/// <typeparam name="T">Type of async loading property</typeparam>
public class LazyProperty<T> : INotifyPropertyChanged
{
    ...
    {
        return await _retrievalFunc(_cancellationTokenSource.Token);
    }
